...
>_Barack Obama, 2016_
  ...
  **🛠️ Les outils**  
  ![Python Github SQL Basthon Jupyter Pix](https://raw.githubusercontent.com/cyrillearduini/nsi_terminale/main/_ressources/0.0.outils1.png "Nos outils")  
  
  **Mais aussi...**  
  
  ![Cahier crayon gomme cerveau](https://raw.githubusercontent.com/cyrillearduini/nsi_terminale/main/_ressources/0.0.outils2.png "Mais à ne pas oublier")
...
<details>
  ...
  ### Jupyter Notebook
  Tous les cours et TP de cette année seront disponibles en ligne sur __Github__ à l'adresse [https://github.com/cyrillearduini/nsi_terminale](https://github.com/cyrillearduini/nsi_terminale) sous forme de __Notebooks Jupyter__.  
  ...
  - **Pour se familiariser avec ces outils, voici un premier TP** : [Notebooks Jupyter, Basthon, Le Markdown](https://notebook.basthon.fr/?from=https://raw.githubusercontent.com/cyrillearduini/nsi_terminale/main/_ressources/0.0_markdown.ipynb)  
...
<details open>
  ...
  >Dans ce chapitre nous allons revoir des notions de première (**types construits** et **algorithmes avancés**) pour être dans les meilleures conditions pour aborder les nouveautés du programme de terminale.  
  - **Types construits** : [P-uplets et tableau indexés](https://notebook.basthon.fr/?from=https://raw.githubusercontent.com/cyrillearduini/nsi_terminale/main/_ressources/0.1_tuples_listes.ipynb)
  - **Types construits** : [Dictionnaires par clés et valeurs](https://notebook.basthon.fr/?from=https://raw.githubusercontent.com/cyrillearduini/nsi_terminale/main/_ressources/0.2_dico.ipynb)
  - **Algorithmes avancés** : [Recherche dichotomique dans un tableau trié](https://notebook.basthon.fr/?from=https://raw.githubusercontent.com/cyrillearduini/nsi_terminale/main/_ressources/0.3_dichotomie.ipynb) 
  - **Algorithmes avancés** : [Les algorithmes de tri](https://notebook.basthon.fr/?from=https://raw.githubusercontent.com/cyrillearduini/nsi_terminale/main/_ressources/0.4_tris.ipynb) 

  ---
  - **Devoir maison** : [Histoire de l’informatique](https://notebook.basthon.fr/?from=https://raw.githubusercontent.com/cyrillearduini/nsi_terminale/main/_ressources/0.5_histoire.ipynb)  
