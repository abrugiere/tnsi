...
- ### [SGBD - Base de données relationnelle](https://notebook.basthon.fr/?kernel=sql&from=https://raw.githubusercontent.com/abrugiere/tnsi/main/_res/2.1_sgbd_relationnel.ipynb){:target="_blank"} + [exercices](https://raw.githubusercontent.com/abrugiere/tnsi/main/_res/2.1_sgbd_relationnel-exos.pdf)

- ### [Langage SQL](https://notebook.basthon.fr/?kernel=sql&from=https://raw.githubusercontent.com/abrugiere/tnsi/main/_res/2.2_sql.ipynb){:target="_blank"}
    +  Exercices BAC : [2025 - Métropole, Mayotte, Antilles, Guyane - ex1](https://raw.githubusercontent.com/abrugiere/tnsi/main/_res/2.3_25-NSIJ1ME1-ex1.pdf) + [2023 - Réunion - ex3](https://raw.githubusercontent.com/abrugiere/tnsi/main/_res/2.3_23-NSIJ2LR1-ex3.pdf) + [2025 - Asie, Pacifique - ex3](https://raw.githubusercontent.com/abrugiere/tnsi/main/_res/2.3_25-NSIJ2JA1-ex3.pdf)

- ### [TP requêtes SQL](https://notebook.basthon.fr/?kernel=sql&from=https://raw.githubusercontent.com/abrugiere/tnsi/main/_res/2.3_tp_sql.ipynb&module=https://raw.githubusercontent.com/abrugiere/tnsi/main/_res/2.3_soccer.db){:target="_blank"} + [Base 2.3_soccer.db](https://raw.githubusercontent.com/abrugiere/tnsi/main/_res/2.3_soccer.db)

- ### Exercices Intéractifs : [SELECT](https://sqlzoo.net/wiki/SELECT_from_Nobel_Tutorial), [SUM et COUNT](https://sqlzoo.net/wiki/SUM_and_COUNT), [JOIN](https://sqlzoo.net/wiki/The_JOIN_operation)
