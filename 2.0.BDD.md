...
- ### [Exercice Intéractif sur les SELECT](https://sqlzoo.net/wiki/SELECT_from_Nobel_Tutorial)
- ### [Exercice Intéractif sur les SUM et COUNT](https://sqlzoo.net/wiki/SUM_and_COUNT)
- ### [Exercice Intéractif sur les JOIN](https://sqlzoo.net/wiki/The_JOIN_operation)
